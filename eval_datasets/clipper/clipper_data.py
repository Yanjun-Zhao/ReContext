...
def load_clipper_data(dataset_name: str, path: str):
    ...
    if dataset_name == "clipper_sp1":
        ...
        selected_data_path = os.path.join(path, "test-100.json")
        data_path = selected_data_path if os.path.exists(selected_data_path) else os.path.join(path, "test-400.json")
